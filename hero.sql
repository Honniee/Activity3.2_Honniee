...
-- Update the status of hero with ID 1 to inactive
--  QUERY:
...
-- Delete the items associated with hero with ID 1 from the HeroItem table
--  QUERY:
...
--  Retrieve player names and their corresponding hero names for active players
--  QUERY:
...
--  List of the average player levels for each class in descending order.
--  QUERY:
